function checkApplicantEditField(input) {
...
function validateApplicantEdit(){
	...
	if(firstNameCheck == "" && lastNameCheck == "" && phoneNumberCheck == "" && !(firstname == "" && lastname == "" && phoneNumber == ""))
	{
		...
		document.getElementById("edit_applicant_error").innerHTML = "";
		document.getElementById("update_form").submit(); 
	}
	else if(firstname == "" && lastname == "" && phoneNumber == "" && passwrd == ""){
		document.getElementById('edit_applicant_error').innerHTML = "All fields are empty, nothing to update.";
	}
	else{
		document.getElementById('edit_applicant_error').innerHTML = "Please correct field values";
	}
}